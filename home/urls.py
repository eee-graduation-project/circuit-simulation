...
urlpatterns = [
    ...
    path('api/component/', views.ComponentViewSet.as_view({'get': 'list', 'post': 'create'})),
    path('api/component/<int:num>/', views.ComponentViewSet.as_view({'put': 'update', 'delete': 'delete'})),
    path('api/wire/', views.WireViewSet.as_view({'get': 'list', 'post': 'create'})),
    path('api/wire/<int:num>/', views.WireViewSet.as_view({'put': 'update', 'delete': 'delete'})),
]
